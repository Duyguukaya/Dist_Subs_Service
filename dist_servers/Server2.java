...
public class Server2 {
    public static void main(String[] args) {
        try {
            ServerSocket serverSocket = new ServerSocket(5002);  // Port 5002
            ...
            while (true) {
                ...
                if (message.getDemand() == Message.MessageProto.Demand.STRT) {
                    System.out.println("Received STRT demand on Server2");
                    ...
                    System.out.println("Received CPCTY demand on Server2");
                    Capacity.CapacityProto capacity = Capacity.CapacityProto.newBuilder()
                            .setServerXStatus(2000)  // Server2 Status
