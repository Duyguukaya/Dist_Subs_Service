...
public class Server3 {
    public static void main(String[] args) {
        try {
            ServerSocket serverSocket = new ServerSocket(5003);  // Port 5003
            ...
            while (true) {
                ...
                if (message.getDemand() == Message.MessageProto.Demand.STRT) {
                    System.out.println("Received STRT demand on Server3");
                    ...
                    System.out.println("Received CPCTY demand on Server3");
                    Capacity.CapacityProto capacity = Capacity.CapacityProto.newBuilder()
                            .setServerXStatus(3000)  // Server3 Status
